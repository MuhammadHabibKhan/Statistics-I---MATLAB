function [] = gmeandeviation_median(L,U,F) %takes input lower and upper limit & frequency
...
f1=F(:,i);
z=(x+y)/2;
MD = sum(f1.*(abs(z-median)))/sum_f;
fprintf ('Grouped Mean Deviation about Median (x̃) :  %.2f\n',MD)
end
